...
IMAGEKIT_PUBLIC_KEY=${IMAGEKIT_PUBLIC_KEY:-replace-with-imagekit-public-key}
IMAGEKIT_PRIVATE_KEY=${IMAGEKIT_PRIVATE_KEY:-replace-with-imagekit-private-key}
...
DB_HOST=localhost
DB_PORT=${DASHBOARD_POSTGRES_PORT:-5435}
DB_NAME=${DASHBOARD_POSTGRES_DB:-dashboard_db}
DB_USERNAME=${DASHBOARD_POSTGRES_USER:-postgres}
DB_PASSWORD=${DASHBOARD_POSTGRES_PASSWORD:-postgres}
KAFKA_BOOTSTRAP_SERVERS=localhost:${KAFKA_EXTERNAL_PORT:-29092}
JOB_SERVICE_URL=http://localhost:8082/api
APPLICATION_SERVICE_URL=http://localhost:8083/api
EOF
