export enum NotificationType {
  CANDIDATE_APPLICATION_APPROVED = 'candidate_application_approved',
  CANDIDATE_APPLICATION_REJECTED = 'candidate_application_rejected',
  ...
  CANDIDATE_JOB_CLOSED = 'candidate_job_closed',
}
